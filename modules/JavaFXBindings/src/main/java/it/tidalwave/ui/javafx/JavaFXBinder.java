...
public interface JavaFXBinder
  {
     ...
     * @param   property2   the latter property
     **********************************************************************************************************************************************************/
    public default void bindBidirectionally (@Nonnull final BoundProperty<? super Boolean> property1, @Nonnull final SimpleBooleanProperty property2)
      {
     ...
     * @param   property2   the latter property
     **********************************************************************************************************************************************************/
    public default void bindBidirectionally (@Nonnull final BoundProperty<? super Integer> property1, @Nonnull final SimpleIntegerProperty property2)
      {
     ...
     * @param   property2   the latter property
     **********************************************************************************************************************************************************/
    public default void bindBidirectionally (@Nonnull final BoundProperty<? super Long> property1, @Nonnull final SimpleLongProperty property2)
      {
     ...
     * @param   property2   the latter property
     **********************************************************************************************************************************************************/
    public default void bindBidirectionally (@Nonnull final BoundProperty<? super Double> property1, @Nonnull final SimpleDoubleProperty property2)
      {
